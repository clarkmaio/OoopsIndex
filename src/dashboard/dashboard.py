...
st.set_page_config(initial_sidebar_state='collapsed', page_icon=':ship:', page_title='Ooops!', layout="centered")
...
with st.sidebar:
    ...
    update_index = st.button(label='Refresh', key='update_index', type='primary', use_container_width=True)
